...
public class OrangeHRMSteps {
	...
	//	driver.findElement(By.xpath("//a[@id='menu_recruitment_viewJobVacancy']")).click();
	 ...
	 @Then("^Enter the details as \"(.*)\" and \"(.*)\" and \"(.*)\" and \"(.*)\"$")
	...
	// @Then("^Add new vacancy as \"(.*)\" and \"(.*)\"$")
	 	@Then("^Add new vacancy as  \"([^\"]*)\" and \"([^\"]*)\"$")	
	    public void adduser(String vacancyname,String hiringmanager) {
	    	...
	    	driver.findElement(By.id("btnSave")).click();
	    	driver.findElement(By.id("btnBack")).click();
	    String actVacancyName =	driver.findElement(By.linkText(vacancyname)).getText();
	   Assert.assertEquals(vacancyname, actVacancyName);
